...
def main() raises:
    ...
    var svm_bench = Python.import_module("svm_bench")
    var data = svm_bench.prepare_data(GLOBAL_SEED) # X_train, X_test, y_train, y_test
    ...
    svm_bench.run_benchmark(GLOBAL_SEED, fit_mean, fit_std, pred_mean, pred_std, accuracy)
