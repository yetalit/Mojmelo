...
def main() raises:
    ...
    var dtr_bench = Python.import_module("dtr_bench")
    var data = dtr_bench.prepare_data(GLOBAL_SEED) # X_train, X_test, y_train, y_test
    ...
    for _ in range(WARMUP):
        var dtr = DecisionTree(criterion='mse', max_depth=10)
