...
def main() raises:
    ...
    var knn_bench = Python.import_module("knn_bench")
    var data = knn_bench.prepare_data(GLOBAL_SEED) # X_train, X_test, y_train, y_test
    ...
    for _ in range(WARMUP):
        var knn = KNN(k=11, search_depth=25)
    ...
    knn_bench.run_benchmark(GLOBAL_SEED, fit_mean, fit_std, pred_mean, pred_std, accuracy)
