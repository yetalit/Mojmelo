...
def main() raises:
    ...
    rfr_bench = Python.import_module("rfr_bench")
    data = rfr_bench.prepare_data(GLOBAL_SEED) # X_train, X_test, y_train, y_test
    ...
    for _ in range(WARMUP):
        rfr = RandomForest[criterion='mse'](n_trees=10, max_depth=10)
