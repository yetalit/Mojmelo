...
def main() raises:
    ...
    var rfr_bench = Python.import_module("rfr_bench")
    var data = rfr_bench.prepare_data(GLOBAL_SEED) # X_train, X_test, y_train, y_test
    ...
    for _ in range(WARMUP):
        var rfr = RandomForest(criterion='mse', n_trees=10, max_depth=10)
    ...
    rfr_bench.run_benchmark(GLOBAL_SEED, fit_mean, fit_std, pred_mean, pred_std, mse)
