...
```mojo
fn def __init__(out self, learning_rate: Float32 = 0.001, n_iters: Int = Int(1000), reg_alpha: Float32 = 0, l1_ratio: Float32 = -1, tol: Float32 = 0, batch_size: Int = Int(0), random_state: Int = Int(-1))
```
