...
def main():
    ...
    grid_params['learning_rate'] = List[String]('0.001', '0.01', '0.1')
    grid_params['n_iters'] = List[String]('100', '500', '1000')
    grid_params['method'] = List[String]('gradient', 'newton')
    grid_params['tol'] = List[String]('0.001', '0.01', '0.1')
    grid_params['reg_alpha'] = List[String]('0.001', '0.005', '0.01')
    best_params, _ = GridSearchCV[LogisticRegression](X, y, grid_params, accuracy_score, cv=4)
